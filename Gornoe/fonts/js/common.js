...
// swiper
  ...
  var apartment = {
    ...
    choose_on: function(thisItem) {
      ...
      console.log($(".apart129-price"));
      console.log($(".apart129-price")[0].textContent);
      //block1
